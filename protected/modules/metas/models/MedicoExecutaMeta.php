	...
	public function attributeLabels()
	{
        ...
        public function isMetaBatida(){
         ...
         public function searchMetasExecutadas() {
                ...
                $where='';
                if($competencia!=null){
                    $where = "where med_exec_meta.competencia='$competencia'";
                }
                $dados=Yii::app()->db->createCommand('select serv.nome as medico,meta.nome as meta,unid.nome as unidade,meta.valor as TotalEsperado,med_exec_meta.total as TotalExecutado 

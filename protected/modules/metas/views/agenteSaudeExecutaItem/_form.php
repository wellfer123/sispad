...
<?php $form=$this->beginWidget('SISPADActiveForm', array(
	'id'=>'agente_saude-executa-item-form',
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <table>
            <tbody>
                ...
                <tr >
                    <td colspan="2">
                        <?php echo $form->labelEx($m,"[$i]agente_saude_cpf"); ?>
                        <?php echo CHtml::textField("[$i]agente_saude_cpf", $agenteSaude->servidor->nome, array('disabled'=>true,'size'=>60)); ?>
                        <?php echo $form->error($m,"[$i]agente_saude_cpf"); ?>
                    </td>
                    <td colspan="2">
                        <?php echo $form->labelEx($m,"[$i]agente_saude_unidade_cnes"); ?>
                        <?php echo CHtml::textField("[$i]agente_saude_unidade_cnes", $agenteSaude->unidade->nome, array('disabled'=>true,'size'=>50)); ?>
                        <?php echo $form->error($m,"[$i]agente_saude_unidade_cnes"); ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>

...
<?php $form=$this->beginWidget('SISPADActiveForm', array(
	'id'=>'agente_saude-executa-meta-form',
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <?php echo $form->labelEx($model,'meta_id'); ?>
                        <?php $this->widget('EJuiAutoCompleteFkField', array(
                                    ...
                                    'sourceUrl'=>Yii::app()->createUrl('metas/Meta/findMetas',array('tipo'=>  Meta::ITENS,'profissao'=>  AgenteSaude::CODIGO_PROFISSAO)), 
                ...
                <tr>
                    <td colspan="2">
                       <?php echo $form->labelEx($model,'agente_saude_cpf'); ?>
                        ...
                        <?php echo $form->error($model,'agente_saude_cpf'); ?>
                    </td>
                </tr>
                 <tr>
                     </td>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'agente-saude-executa-item-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'agente_saude_unidade_cnes'); ?>
		<?php echo $form->textField($model,'agente_saude_unidade_cnes',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'agente_saude_unidade_cnes'); ?>
	</div>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'agente-saude-executa-meta-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'agente_saude_microarea'); ?>
		<?php echo $form->textField($model,'agente_saude_microarea'); ?>
		<?php echo $form->error($model,'agente_saude_microarea'); ?>
	</div>

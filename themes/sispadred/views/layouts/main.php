...
"menu"=>array(
          ...
          array("url"=>array(),
                      ...
                      array("url"=>array("route"=>""), "label"=>"Metas Executadas",
                          array("url"=>array("route"=>"/medicoExecutaMeta/preparedAdmin"), "label"=>"Médico"),
                          array("url"=>array("route"=>"/enfermeiroExecutaMeta/preparedAdmin"), "label"=>"Enfermeiro"),
                          array("url"=>array("route"=>"/odontologoExecutaMeta/preparedAdmin"), "label"=>"Odontologo"),
                          array("url"=>array("route"=>"/agenteSaudeExecutaMeta/preparedAdmin"), "label"=>"Agente de Saúde"),
                      ),
